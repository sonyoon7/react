...
const serverRender = async (req, res, next) => {
  ...
  //toPromise는 sagaMiddleware.run을 통해 만든 Task를 Promise로 변환합니다.
  //별도의 작업을 하지 않으면 이 Promise는 끝나지 않습니다.우리가 만든 rootSaga에서 액션을 끝없이 모니터 하기 때문
  ...
  //END라는 액션을 발생시키면Promise를 끝낼수 있음  Promise가 끝나는 시점에 flejrtm tmxhdjdpsms 우리가 원하는 데이터가 채워집니다
  store.dispatch(END)
